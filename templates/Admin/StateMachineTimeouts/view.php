...
<nav class="actions large-3 medium-4 columns col-sm-4 col-12" id="actions-sidebar">
    <ul class="side-nav nav nav-pills nav-stacked">
        ...
        <li class="nav-link"><?= $this->Form->postLink(__('Delete State Machine Timeout'), ['action' => 'delete', $stateMachineTimeout->id], ['confirm' => __('Are you sure you want to delete # {0}?', $stateMachineTimeout->id)]) ?> </li>
        <li class="nav-link"><?= $this->Html->link(__('List State Machine Timeouts'), ['action' => 'index']) ?> </li>
