...
<nav class="actions large-3 medium-4 columns col-sm-4 col-12" id="actions-sidebar">
    <ul class="side-nav nav nav-pills nav-stacked">
        ...
        <li class="nav-link"><?= $this->Form->postLink(__('Delete State Machine Item State History'), ['action' => 'delete', $stateMachineItemStateLog->id], ['confirm' => __('Are you sure you want to delete # {0}?', $stateMachineItemStateLog->id)]) ?> </li>
        <li class="nav-link"><?= $this->Html->link(__('List State Machine Item State History'), ['action' => 'index']) ?> </li>
