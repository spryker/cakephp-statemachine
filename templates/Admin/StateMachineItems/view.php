...
<nav class="actions large-3 medium-4 columns col-sm-4 col-xs-12" id="actions-sidebar">
    <ul class="side-nav nav nav-pills nav-stacked">
        ...
        <?php } ?>
        <li><?= $this->Form->postLink($this->Format->icon('delete') . ' ' . __('Delete'), ['action' => 'delete', $stateMachineItem->id], ['escapeTitle' => false, 'confirm' => __('Are you sure you want to delete # {0}?', $stateMachineItem->id)]); ?></li>
    </ul>
</nav>
