...
<nav class="actions large-3 medium-4 columns col-sm-4 col-xs-12" id="actions-sidebar">
    <ul class="side-nav nav nav-pills nav-stacked">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $stateMachineTransitionLog->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $stateMachineTransitionLog->id)]
            )
        ?></li>
...
<div class="content action-form form large-9 medium-8 columns col-sm-8 col-xs-12">
    ...
    <fieldset>
        <legend><?= __('Edit State Machine Transition Log') ?></legend>
        <?php
